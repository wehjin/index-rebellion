...
sealed class BiMargin {
    ...
    data class Uniform(val span: Span) : BiMargin() {
        override val hMargin: Margin = Margin.Uniform(span)
        override val vMargin: Margin = Margin.Uniform(span)
    }
    ...
    data class AxisIndependent(val hSpan: Span, val vSpan: Span) : BiMargin() {
        override val hMargin: Margin = Margin.Uniform(hSpan)
        override val vMargin: Margin = Margin.Uniform(vSpan)
    }

    data class Independent(val start: Span, val end: Span, val ceiling: Span, val floor: Span) : BiMargin() {
        override val hMargin: Margin = Margin.Independent(start, end)
        override val vMargin: Margin = Margin.Independent(ceiling, floor)
    }

    data class Start(val span: Span) : BiMargin() {
        override val hMargin: Margin = Margin.Head(span)
        override val vMargin: Margin = Margin.None
    }

    data class End(val span: Span) : BiMargin() {
        override val hMargin: Margin = Margin.Tail(span)
        override val vMargin: Margin = Margin.None
    }

    data class Ceiling(val span: Span) : BiMargin() {
        override val hMargin: Margin = Margin.None
        override val vMargin: Margin = Margin.Head(span)
    }

    data class Floor(val span: Span) : BiMargin() {
        override val hMargin: Margin = Margin.None
        override val vMargin: Margin = Margin.Tail(span)
    }
